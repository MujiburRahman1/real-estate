    ...
    id='About'>
      ...
      <div className='flex flex-col md:flex-row item-center md:items-start md:gap-20'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
            ...
            <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veniam ipsa excepturi, ipsam sed facere fugit obcaecati optio et itaque provident dicta officia corrupti velit, iusto nemo tempore hic? Sunt, perferendis.</p>
